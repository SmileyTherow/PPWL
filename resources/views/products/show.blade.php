        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-md-7">
                    ...
                    <h4 class="text-primary fw-bold mb-3">Rp {{ number_format($product->harga, 0, ',', '.') }}</h4>
                    <p>{{ $product->deskripsi }}</p>
                    <p class="mt-3"><span class="fw-bold">Stok:</span>
                        {{ $product->stok > 0 ? $product->stok . ' tersedia' : 'Habis' }}</p>
